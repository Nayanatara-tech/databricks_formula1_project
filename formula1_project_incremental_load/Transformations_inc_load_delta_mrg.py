...
# MAGIC %sql
# MAGIC CREATE DATABASE IF NOT EXISTS f1_presentation_incre_ld_delta_mrg;
...
processed_results_df=spark.sql("SELECT * FROM f1_processed_incre_ld_delta_mrg.results")
...
delta_merge(race_results_df,'race_id','f1_presentation_incre_ld_delta_mrg','race_results',merge_condition)


# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT race_id,count(*) from f1_presentation_incre_ld_delta_mrg.race_results
...
delta_merge(driver_standings_df,'race_year','f1_presentation_incre_ld_delta_mrg','driver_standings',merge_condition)
...
delta_merge(constructor_standings_df,'race_year','f1_presentation_incre_ld_delta_mrg','constructor_standings',merge_condition)
